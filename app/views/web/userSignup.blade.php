            ...
            <div class="container">
                ...
                <form class="form-login" action="{{route('/user/save')}}" method="post">
                    ...
                    <div class="login-wrap">
                        <input type="text" name="first_name" required class="form-control" placeholder="First Name" autofocus><br>
                        <input type="text" name="last_name" required class="form-control" placeholder="Last Name" ><br>
