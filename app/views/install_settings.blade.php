    ...
    <form role="form" method="POST" action="{{ URL::Route('AdminInstallFinish') }}">
        ...
        <div class="box-body">
            ...
            ?>">
                ...
                <input type="text" class="form-control"  name="mandrill_secret" placeholder="Mandrill Secret" value="{{Config::get('services.mandrill.secret')?Config::get('services.mandrill.secret'):''}}">
