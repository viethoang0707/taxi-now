            ...
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="{{ web_url() }}" style="color:#ffffff; outline:none; text-decoration:none;">Ride Booking Request</a></span>
                    </td>
                </tr>
                <!-- <tr>
                            ...
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                                        ...
                                        <strong style="font-weight: bold;">{{ $mail_body['trip_id'] }}</strong>. 
                                        Follow the request through 
                                        <a href="{{ $mail_body['follow_url'] }}" style="color:#545454; outline:none; text-decoration:none;"><strong style="font-weight: bold;"> URL </strong></a>. 
                                        <?php /* echo "App Name"; */echo ucwords(Config::get('app.website_title')); ?>
                                    </div>
                                    <br>
                                    <div style="text-align:center"><a href="{{ web_url() }}" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #ff9d3d;color:#fff;text-align:center;  text-decoration: none;">Follow</a></div>
