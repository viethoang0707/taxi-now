...
// Provider Availability
    ...
    public function theme() {
        ...
        if (Input::hasFile('logo')) {
            ...
            $f_name1 = Input::file('logo')->getClientOriginalName();
            /* move_uploaded_file($f_name1, public_path() . "/uploads/" . $file_name . "." . $ext); */
            /* copy($f_name1, public_path() . "/uploads/" . $file_name . "." . $ext); */
        ...
        if (Input::hasFile('icon')) {
            ...
            $f_name = Input::file('icon')->getClientOriginalName();
            /* copy($f_name, public_path() . "/uploads/" . $file_name1 . "." . $ext1); */
            /* move_uploaded_file($f_name, public_path() . "/uploads/" . $file_name1 . "." . $ext1); */
